...
from DAgger_env import  BulletEnvironment, test_model
...
if not os.path.exists(CSV_FILE):
    with open(CSV_FILE, mode="w", newline="") as file:
        ...
        writer.writerow(["Iteration", "Cube_Index", "Stacking_Success", "Attempts", "cube_gripped_successfully"])
    ...
    for _ in range(len(cube_ids) - 1):
        ...
        while not stacking_success:
            ...
            with open(CSV_FILE, mode="a", newline="") as file:
                writer = csv.writer(file)
                writer.writerow([iterations,j, stacking_success, current_cube_attempt, cube_gripped_successfully])
